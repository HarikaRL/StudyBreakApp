...
public class PaintByNumbers extends AppCompatActivity {
    ...
    int[] commonColors = {Color.rgb(51,0,0), Color.rgb(51,25,0)
            , Color.rgb(51,51,0), Color.rgb(25,51,0),
            Color.rgb(0,51,0),
            Color.rgb(0,51,25), Color.rgb(0,51,51),
            Color.rgb(0,25,51),
            Color.rgb(0,0,51), Color.rgb(25,0,51),
            Color.rgb(51,0,51),
            Color.rgb(51,0,25), Color.rgb(0,0,0),
            Color.rgb(102,0,0),
            Color.rgb(102,51,0), Color.rgb(102,102,0),
            Color.rgb(51,102,0),
            Color.rgb(0,102,0), Color.rgb(0,102,51),
            Color.rgb(0,102,102),
            Color.rgb(0,51,102), Color.rgb(0,0,102),
            Color.rgb(51,0,102),
            Color.rgb(102,0,102), Color.rgb(102,0,51),
            Color.rgb(32,32,32),
            Color.rgb(153,0,0), Color.rgb(153,76,0),
            Color.rgb(153,153,0),
            Color.rgb(76,153,0), Color.rgb(0,153,0),
            Color.rgb(0,153,76),
            Color.rgb(0,153,153), Color.rgb(0,76,153),
            Color.rgb(0,0,153),
            Color.rgb(76,0,153), Color.rgb(153,0,153),
            Color.rgb(153,0,76),
            Color.rgb(64,64,64), Color.rgb(204,0,0),
            Color.rgb(204,102,0),
            Color.rgb(204,204,0), Color.rgb(102,204,0),
            Color.rgb(0,204,0),
            Color.rgb(0,204,102), Color.rgb(0,204,204),
            Color.rgb(0,102,204),
            Color.rgb(0,0,204), Color.rgb(102,0,204),
            Color.rgb(204,0,204),
            Color.rgb(204,0,102), Color.rgb(96,96,96),
            Color.rgb(255,0,0),
            Color.rgb(255,128,0), Color.rgb(255,255,0),
            Color.rgb(128,255,0),
            Color.rgb(0,255,0), Color.rgb(0,255,128),
            Color.rgb(0,255,255),
            Color.rgb(0,128,255), Color.rgb(0,0,255),
            Color.rgb(128,0,255), Color.rgb(255,0,255),
            Color.rgb(255,0,128), Color.rgb(128,128,128),
            Color.rgb(255,51,51),
            Color.rgb(255,153,51), Color.rgb(255,255,51),
            Color.rgb(153,255,51),
            Color.rgb(51,255,51), Color.rgb(51,255,153),
            Color.rgb(51,255,255),
            Color.rgb(51,153,255), Color.rgb(51,51,255),
            Color.rgb(153,51,255),
            Color.rgb(255,51,255), Color.rgb(255,51,153),
            Color.rgb(160,160,160),
            Color.rgb(255,102,102), Color.rgb(255,178,102),
            Color.rgb(255,255,102),
            Color.rgb(178,255,102), Color.rgb(102,255,102),
            Color.rgb(102,255,178),
            Color.rgb(102,255,255), Color.rgb(102,178,255),
            Color.rgb(102,102,255),
            Color.rgb(178,102,255), Color.rgb(255,102,255),
            Color.rgb(255,102,178),
            Color.rgb(192,192,192), Color.rgb(255,153,153),
            Color.rgb(255,204,153),
            Color.rgb(255,255,153), Color.rgb(204,255,153),
            Color.rgb(153,255,153),
            Color.rgb(153,255,204), Color.rgb(153,255,255),
            Color.rgb(153,204,255),
            Color.rgb(153,153,255), Color.rgb(204,153,255),
            Color.rgb(255,153,255),
            Color.rgb(255,153,204), Color.rgb(224,224,224),
            Color.rgb(255,204,204),
            Color.rgb(255,229,204), Color.rgb(255,255,204),
            Color.rgb(229,255,204),
            Color.rgb(204,255,204), Color.rgb(204,255,229),
            Color.rgb(204,255,255),
            Color.rgb(204,229,255), Color.rgb(204,204,255),
            Color.rgb(229,204,255),
            Color.rgb(255,204,255), Color.rgb(255,204,229),
                ...
                for (int k = 0; k < 30; k++) {
                    for (int l = 0; l < 30; l++) {
                        ...
                        for (int m = 0; m < commonColors.length; m++) {
                            if ((int)(Math.pow(Color.red(pixel)-Color.red(commonColors[m]),2)
                                    +Math.pow(Color.green(pixel)-Color.green(commonColors[m]),2)
                                    +Math.pow(Color.blue(pixel) - Color.blue(commonColors[m]),2))
                                    < minDist) {
                                minDist = (int)(Math.pow(Color.red(pixel)-
                                        Color.red(commonColors[m]),2)+Math.pow(Color.green(pixel)-
                                        Color.green(commonColors[m]),2)+Math.pow(Color.blue(pixel)
                                        - Color.blue(commonColors[m]),2));
                                nearestPos = m;
                            }
                        }
    ...
    /**
     * Takes a naive pixel grid with at most 117 colors and converts it to a pixel grid with at
     * most 13 colors.
    ...
    public int[][][] modifiedPixelGrid(int[][][] pixelGrid, ArrayList<Integer> mostCommonColors) {
        ...
        for (int i = 0; i < pixelGrid.length; i++) {
            for (int j = 0; j < pixelGrid[i].length; j++) {
                ...
                for (int k = 0; k < mostCommonColors.size(); k++) {
                        if ((int)(Math.pow(pixelGrid[i][j][0]-Color.red(mostCommonColors.get(k)),2)
                                +Math.pow(pixelGrid[i][j][1]
                                -Color.green(mostCommonColors.get(k)),2)
                                +Math.pow(pixelGrid[i][j][2]
                                - Color.blue(mostCommonColors.get(k)),2)) < minDist) {
                            minDist = (int)(Math.pow(pixelGrid[i][j][0]
                                    -Color.red(mostCommonColors.get(k)),2)
                                    +Math.pow(pixelGrid[i][j][1]
                                    -Color.green(mostCommonColors.get(k)),2)
                                    +Math.pow(pixelGrid[i][j][2]
                                    - Color.blue(mostCommonColors.get(k)),2));
